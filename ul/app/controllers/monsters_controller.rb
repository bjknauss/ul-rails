class MonstersController < ApplicationController
  ...
  private
    ...
    def monster_params
      params.require(:monster).permit(:name, :rarity_id, :element_id, :stat_element_id, :cost, :current_reforge, :max_reforge, :top_stat, :bot_stat, :skill_name, :skill_description, :thumbnail)
    end
end
