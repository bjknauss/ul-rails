...
class TargetsControllerTest < ActionController::TestCase
  ...
  test "should create target" do
    assert_difference('Target.count') do
      post :create, target: { description: @target.description, name: @target.name, team: @target.team, type: @target.type }
    end
  ...
  test "should update target" do
    patch :update, id: @target, target: { description: @target.description, name: @target.name, team: @target.team, type: @target.type }
    assert_redirected_to target_path(assigns(:target))
  end
