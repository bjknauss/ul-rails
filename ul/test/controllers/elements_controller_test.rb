...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { name: @element.name, stat_bot: @element.stat_bot, stat_top: @element.stat_top }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { name: @element.name, stat_bot: @element.stat_bot, stat_top: @element.stat_top }
    assert_redirected_to element_path(assigns(:element))
  end
